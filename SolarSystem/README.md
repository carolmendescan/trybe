...
<details>
  ...
  * Data para entrega final do projeto: `31/01/2023 14:00`.
...
<details>
  ...
  - Use o comando: `git clone git@github.com:tryber/sd-028-a-project-solar-system.git`.
  - Entre na pasta do repositório que você acabou de clonar:
    - `cd sd-028-a-project-solar-system`
  ...
  - Agora crie uma branch à qual você vai submeter os `commits` do seu projeto
    ...
    - Exemplo: `git checkout -b joaozinho-sd-028-a-project-solar-system>`
  ...
  - Usando o exemplo anterior: `git push -u origin joaozinho-sd-028-a-project-solar-system`

  6. Crie um novo `Pull Request` _(PR)_

  - Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-028-a-project-solar-system/pulls)
  ...
  - Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-028-a-project-solar-system/pulls) e confira que o seu _Pull Request_ está criado
