...
<details>
  ...
  - Use o comando: `git clone git@github.com:tryber/sd-028-a-project-todo-list.git`
  - Entre na pasta do repositório que você acabou de clonar:
    - `cd sd-028-a-project-todo-list`
  ...
  - Verifique que você está na raiz do projeto
    - Exemplo: `pwd` -> o retorno vai ser algo tipo _/Users/joaozinho/code/**sd-028-a-project-todo-list**_
  ...
  - Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-028-a-project-todo-list/pulls)
  ...
  - Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-028-a-project-todo-list/pulls) e confira que o seu _Pull Request_ está criado
