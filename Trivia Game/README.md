...
<details>
  ...
  - Use o comando: `git clone git@github.com:tryber/sd-028-a-project-trivia-react-redux.git`.
  - Entre na pasta do repositório que você acabou de clonar:
    - `cd sd-028-a-project-trivia-react-redux`
  ...
  - Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-028-a-project-trivia-react-redux/pulls)
  ...
  - Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-028-a-project-trivia-react-redux/pulls) e confira que o seu _Pull Request_ está criado
...
[FORMULÁRIO DE AVALIAÇÃO DE PROJETO](https://be-trybe.typeform.com/to/ZTeR4IbH#cohort_hidden=CH28-A&template=betrybe/sd-0x-project-trivia-react-redux)
